    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          ...
          <h1 className="login-title">Admin Password Reset</h1>
        ...
        <div className="login-footer">
          <Link to="/admin" className="forgot-password-link" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
